...
class VendingMachine:
    ...
    def add_funds(self, n):
        ...
        # stock have
        if self.stock = 0:
            return 'Nothing left to vend'
        self.balance += n
        return 'OK, Your balance is ' + self.balance + '$'
    ...
    def vend(self):
        ...
        # if stock != 0 
        if self.stock == 0:
            return "Sorry,Nothing left to vend. Please restock"

        # if balance is not  enough 
        if self.balance < self.price:
            X = self.price - self.balance
            return 'please add ' + X + '$ more funds.'

        # enough balance && stock != 0
        if self.balance - self.price == 0:
           ...
           Y = self.balance
           return 'Here is your PRODUCT and ' + Y + '$ change
